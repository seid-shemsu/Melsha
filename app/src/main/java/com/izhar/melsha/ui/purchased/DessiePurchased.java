...
public class DessiePurchased extends Fragment {
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_dessie_purchased, container, false);
    ...
    void getPurchased() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, utils.getUrl(getContext()) +
                "?action=getBranchItemPurchased&branch=Dessie",
                response -> {
                    try {
