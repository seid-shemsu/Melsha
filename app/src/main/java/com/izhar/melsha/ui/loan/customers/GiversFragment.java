 ...
 * Use the {@link GiversFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GiversFragment extends Fragment {
     ...
     * @return A new instance of fragment Givers.
     */
    // TODO: Rename and change types and number of parameters
    public static GiversFragment newInstance(String param1, String param2) {
        GiversFragment fragment = new GiversFragment();
    ...
    private TextView no;
    List<LoanGiverModel> givers = new ArrayList<>();
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (search.getText().toString().isEmpty()) {
                    adapter = new LoanGiverAdapter(getContext(), givers);
                } else {
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            LoanGiverModel giver = new LoanGiverModel();
                            giver.setCode(object.getString("pcode"));
                            giver.setName(object.getString("pname"));
                            giver.setPhone(object.getString("pphone"));
                            if (object.getString("amount").equalsIgnoreCase(""))
                                giver.setTotal(0);
                            else
                                giver.setTotal(object.getInt("amount"));
                            if (object.getString("left").equalsIgnoreCase(""))
                                giver.setLeft(0);
                            else
                                giver.setLeft(object.getInt("left"));
                            if (object.getString("payed").equalsIgnoreCase(""))
                                giver.setPayed(0);
                            else
                                giver.setPayed(object.getInt("payed"));
                            givers.add(giver);
                        }
                        adapter = new LoanGiverAdapter(getContext(), givers);
                        recycler.setAdapter(adapter);
