package com.izhar.melsha.ui.m_expense;
 ...
 * Use the {@link MExpense#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MExpense extends Fragment {
    ...
    public static MExpense newInstance(String param1, String param2) {
        MExpense fragment = new MExpense();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (branch.equalsIgnoreCase("owner")){
            ...
            no_store.setText("Unauthorized access");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, utils.getUrl(getContext()) +
                ...
                response -> {
                    try {
                        ...
                        adapter = new ExpenseAdapter(getContext(), expenses,"monthly");
